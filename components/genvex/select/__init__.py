...
from .. import Genvex, CONF_NILAN_ID
...
GenvexSelect = genvex_ns.class_('GenvexSelect', select.Select, cg.Component)
 
CONFIG_SCHEMA = select.SELECT_SCHEMA.extend({
    cv.GenerateID(): cv.declare_id(GenvexSelect),
    cv.GenerateID(CONF_NILAN_ID): cv.use_id(Genvex),
