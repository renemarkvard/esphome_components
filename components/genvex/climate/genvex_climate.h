...
private:
  ...
  void genvexfanspeed_to_fanmode(const int state);
//  int climatemode_to_genvexoperationmode(const climate::ClimateMode mode);
  void genvexmodetext_to_climatemode(const std::string& genvex_mode);
};
} // namespace genvex
} // namespace esphome
